...
class serverConnection implements Runnable {
  ...
  public int hasChan( String c ) {
  	...
  	while ((i < chanList.size()) && (!found)) {
		  ...
		  cv = (Vector)cv.elementAt(0);
		  
		  if (c.equalsIgnoreCase((String)cv.elementAt(0) ) )
		  	found = true;
  ...
  //add a chan with no users on it
  ...
  public String namesList( int cid ) {
  	Vector c = (Vector)chanList.elementAt( cid );
  	
  	String nl = "";
  	for (int i=1; i< c.size(); i++)
  		nl = nl + " " + (String)c.elementAt(i);
  		
  	return nl.substring(1);
  }
  ...
  public void setChanOption( String c, String arm, String o, String s ) {
  	...
  	while ((i < chanList.size()) && (!found)) {
  		...
  		if (c.equalsIgnoreCase( (String)settings.elementAt(0) ) ) {
  			...
  			if (arm.equals("ADD")) {
  				//System.out.println("Adding chan option: " c + " :" + o + " " + s );
					//if (o.equals("TOPIC")) {
		...
		try {
			...
			connected = true;
				    ...
				    //BufferedReader input = new BufferedReader(new InputStreamReader(sock.getInputStream())); 
					    ...
					    DataInputStream input = s.getDataStream();
					...
					String line = "";
				    	...
				    	while ( true ) {
					    	...
					    	/*
					    		...
					    		pw.print("PING X\r\n");
					    		pw.flush();
					    		//System.out.println( serverName + ":!: PING?PONG!" );
					    	}
					    	*/
					    	/*
					    	else {
