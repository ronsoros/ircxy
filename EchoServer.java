...
try {
  ...
  public void welcomeUser( int userID ) throws IOException {
	...
	tellUser( userID, ":" + serverName + " 004 " + userNick + " IRCXY-" + version + " iox biklmnopqrstv" );

	tellUser( userID, ":" + serverName + " 005 " + userNick + " IRCv4 PROTOCOL=IRCv4 MAXCHANNELS=" + max_channels
															 + " NICKLEN=" + maxNickLen
